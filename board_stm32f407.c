...
#include "board_stm32f407.h"				//we use board-specific defs
...
const PIN2GPIO GPIO_PinDef[]={
...
#if defined(RCC_AHB1ENR_GPIOFEN)			//GPIOF not present on all chips
...
#if defined(RCC_AHB1ENR_GPIOGEN)			//GPIOG not present on all chips
...
#if defined(RCC_AHB1ENR_GPIOHEN)			//GPIOH not present on all chips
	...
	{GPIOH, 1 <<  8},						//ARMduino Pin 48 = PG8
	{GPIOH, 1 <<  9},						//ARMduino Pin 49 = PG9
	{GPIOH, 1 << 10},						//ARMduino Pin 50 = PG10
	{GPIOH, 1 << 11},						//ARMduino Pin 51 = PG11
	{GPIOH, 1 << 12},						//ARMduino Pin 52 = PG12
	{GPIOH, 1 << 13},						//ARMduino Pin 53 = PG13
	{GPIOH, 1 << 14},						//ARMduino Pin 54 = PG14
	{GPIOH, 1 << 15},						//ARMduino Pin 55 = PG15
#endif

#if defined(RCC_AHB1ENR_GPIOIEN)			//GPIOI not present on all chips
	...
	{GPIOI, 1 <<  8},						//ARMduino Pin 48 = PG8
	{GPIOI, 1 <<  9},						//ARMduino Pin 49 = PG9
	{GPIOI, 1 << 10},						//ARMduino Pin 50 = PG10
	{GPIOI, 1 << 11},						//ARMduino Pin 51 = PG11
	{GPIOI, 1 << 12},						//ARMduino Pin 52 = PG12
	{GPIOI, 1 << 13},						//ARMduino Pin 53 = PG13
	{GPIOI, 1 << 14},						//ARMduino Pin 54 = PG14
	{GPIOI, 1 << 15},						//ARMduino Pin 55 = PG15
#endif
};
